      ...
      <div className="footer__body">
        <div className="footer__container">
          ...
          <div className="footer__col footer__col--brand">
            ...
            <div className="footer__socials">
              <a href="https://www.instagram.com/smm_kadr?igsh=MWZvcjRocHN0M255Mg==" className="footer__social" aria-label="Instagram">
              ...
              <a href="https://wa.me/996503030018" className="footer__social" aria-label="WhatsApp">
        ...
        <div className="footer__bottom">
          ...
          <div className="footer__bottom-links">
            ...
            <Link to="/terms" className="footer__bottom-link">Условия использования</Link>
          </div>
        </div>
      </div>
    </footer>
