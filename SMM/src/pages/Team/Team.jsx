...
const team = [
  ...
  { name: "Эржан Алкожоев",        role: "Заместитель директора, таргетолог",                img: "erzhan.png" },
  { name: "Бегимай",               role: "РОП",                                  img: "begimay.jpg" },
  { name: "Асема Исмаилбекова",    role: "Менеджер по продажам",                             img: "asema.png" },
...
const roleColors = {
  ...
  "Директор":                 "#2563EB",
  "Заместитель директора, таргетолог":    "#0891B2",
  "РОП":                      "#059669",
  "Менеджер по продажам":                 "#059669",
  "Амбассадор":               "#D97706",
  "Маркетолог":               "#DC2626",
  "Мобилограф":               "#7C3AED",
...
function getRoleGroup(role) {
  if (["Основатель", "Сооснователь, Финансовый директор", "Директор", "Заместитель директора, таргетолог", "РОП"].includes(role)) return "Руководство";
  if (["Маркетолог","Менеджер по продажам", "Главный программист "].includes(role)) return "Маркетинг";
